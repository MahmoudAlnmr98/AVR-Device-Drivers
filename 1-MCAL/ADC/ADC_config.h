...
/*
 * reference voltage:
 * 00 	AREF and internal Vref is turned off
 * 01	AVCC with external capacitor on AREF
 * 10	reserved, not used
 * 11	internal 2.56V reference with external capacitor on AREF
 */
#define AREF						1
#define AVCC						2
#define INTERNAL_2_56V				3

#define ADC_REFERENCE_VOLATGE		AVCC
